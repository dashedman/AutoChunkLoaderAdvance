package de.pauleff.jnbt.formats.binary;

import de.pauleff.jnbt.api.ICompoundTag;
import de.pauleff.jnbt.api.INBTReader;
import de.pauleff.jnbt.core.*;
...
{
    private final de.pauleff.jnbt.formats.binary.PositionTrackingDataInputStream stream;
    ...
    public NBTReader(File nbtFile)
    {
        try
        {
            ...
            this.stream = new de.pauleff.jnbt.formats.binary.PositionTrackingDataInputStream(baseStream);
        } catch (IOException e)
        {
    ...
    {
        this.stream = new de.pauleff.jnbt.formats.binary.PositionTrackingDataInputStream(dis);
    }
     ...
     * @return A {@link de.pauleff.jnbt.formats.binary.PositionTrackingDataInputStream} for enhanced error reporting
     */
    public static de.pauleff.jnbt.formats.binary.PositionTrackingDataInputStream byteArrayToDataInputStream(byte[] chunkData)
    {
