...
public class SNBTTokenizer
{
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if tokenization fails due to invalid syntax
     */
    public Token nextToken() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if the string is unterminated or has invalid escape sequences
     */
    private Token parseQuotedString(char quote, int tokenStart) throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        while (position < length)
        {
            ...
            } else if (c == '\\')
            {
                ...
                if (position >= length)
                {
                    throw new de.pauleff.jnbt.formats.snbt.SNBTException("Unterminated escape sequence", position, input);
                }
                ...
                switch (escaped)
                {
                    ...
                    case 'u':
                        ...
                        {
                            throw new de.pauleff.jnbt.formats.snbt.SNBTException("Incomplete unicode escape sequence", position, input);
                        }
                        try
                        {
                        ...
                        {
                            throw new de.pauleff.jnbt.formats.snbt.SNBTException("Invalid unicode escape sequence", position, input, e);
                        }
                        break;
                    default:
        ...
        throw new de.pauleff.jnbt.formats.snbt.SNBTException("Unterminated string", tokenStart, input);
    }
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if the number format is invalid
     */
    private Token parseNumber(int tokenStart) throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        StringBuilder sb = new StringBuilder();
