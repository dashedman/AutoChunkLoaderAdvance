package de.pauleff.jnbt.formats.snbt;
...
import de.pauleff.jnbt.core.Collection_Tag;
import de.pauleff.jnbt.formats.snbt.SNBTTokenizer.Token;
import de.pauleff.jnbt.formats.snbt.SNBTTokenizer.TokenType;
...
public class SNBTParser
{
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails due to syntax errors
     */
    public ITag<?> parse() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        {
            throw new de.pauleff.jnbt.formats.snbt.SNBTException("Unexpected token after parsing completed",
     ...
     *
     * @return the parsed NBT tag
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails
     */
    private ITag<?> parseValue() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        switch (currentToken.getType())
        {
            ...
            case NUMBER:
                return parseNumber();
            default:
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Unexpected token: " + currentToken.getType(),
                        currentToken.getPosition(), tokenizer.getInput());
        }
    }
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails
     */
    private ICompoundTag parseCompound() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        do
        {
            ...
            {
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Expected string key in compound",
                        currentToken.getPosition(), tokenizer.getInput());
            }
            ...
            {
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Expected ',' or '}' in compound",
                        currentToken.getPosition(), tokenizer.getInput());
            }
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails
     */
    private ITag<?> parseListOrArray() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails or array type is unknown
     */
    private ITag<?> parseArray() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        switch (prefix)
        {
            ...
            default:
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Unknown array prefix: " + prefix,
                        currentToken.getPosition(), tokenizer.getInput());
        }
    }
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails or values are not bytes
     */
    private ITag<byte[]> parseByteArray() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        do
        {
            ...
            {
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Expected byte value in byte array",
                        currentToken.getPosition(), tokenizer.getInput());
            }
            ...
            {
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Expected ',' or ']' in array",
                        currentToken.getPosition(), tokenizer.getInput());
            }
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails or values are not integers
     */
    private ITag<int[]> parseIntArray() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        do
        {
            ...
            {
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Expected int value in int array",
                        currentToken.getPosition(), tokenizer.getInput());
            }
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails or values are not longs
     */
    private ITag<long[]> parseLongArray() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        do
        {
            ...
            {
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Expected long value in long array",
                        currentToken.getPosition(), tokenizer.getInput());
            }
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails or mixed types are found
     */
    private IListTag parseList() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        while (currentToken.getType() == TokenType.COMMA)
        {
            ...
            {
                throw new de.pauleff.jnbt.formats.snbt.SNBTException("Mixed types in list not allowed. Expected type " +
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails
     */
    private ITag<?> parseStringValue() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if parsing fails or number format is invalid
     */
    private ITag<?> parseNumber() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
        ...
        try
        {
            ...
            if (Character.isLetter(lastChar))
            {
                ...
                switch (suffix)
                {
                    ...
                    default:
                        throw new de.pauleff.jnbt.formats.snbt.SNBTException("Unknown numeric suffix: " + suffix,
                                currentToken.getPosition(), tokenizer.getInput());
                }
            } else
            {
        ...
        {
            throw new de.pauleff.jnbt.formats.snbt.SNBTException("Invalid number format: " + numberStr,
     ...
     *
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if tokenization fails
     */
    private void advance() throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
     ...
     * @throws de.pauleff.jnbt.formats.snbt.SNBTException if the current token does not match the expected type
     */
    private void expect(TokenType expectedType) throws de.pauleff.jnbt.formats.snbt.SNBTException
    {
