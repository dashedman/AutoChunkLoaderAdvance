 ...
 * common data types.</p>
 * <p>Extends {@link de.pauleff.jnbt.core.Collection_Tag} with compound-specific operations and
...
public class Tag_Compound extends Collection_Tag implements ICompoundTag
{
     ...
     */
    public Tag_Compound(String name, ArrayList<de.pauleff.jnbt.core.Tag<?>> data)
    {
     ...
     * @see de.pauleff.jnbt.core.Tag_String
     */
     ...
     * @return this compound tag for fluent operations
     * @see de.pauleff.jnbt.core.Tag_Int
     */
     ...
     * @return this compound tag for fluent operations
     * @see de.pauleff.jnbt.core.Tag_Double
     */
     ...
     * @return this compound tag for fluent operations
     * @see de.pauleff.jnbt.core.Tag_Float
     */
     ...
     * @return this compound tag for fluent operations
     * @see de.pauleff.jnbt.core.Tag_Byte
     */
     ...
     * @return this compound tag for fluent operations
     * @see de.pauleff.jnbt.core.Tag_Long
     */
     ...
     * @return this compound tag for fluent operations
     * @see de.pauleff.jnbt.core.Tag_Byte_Array
     */
    public ICompoundTag addByteArray(String name, byte[] value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Byte_Array(name, value));
        return this;
    }
     ...
     * @return this compound tag for fluent operations
     * @see de.pauleff.jnbt.core.Tag_Int_Array
     */
    public ICompoundTag addIntArray(String name, int[] value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Int_Array(name, value));
        return this;
    }
     ...
     * @return this compound tag for fluent operations
     * @see de.pauleff.jnbt.core.Tag_Long_Array
     */
    public ICompoundTag addLongArray(String name, long[] value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Long_Array(name, value));
        return this;
    }
    ...
    {
        de.pauleff.jnbt.core.Tag<?> tag = getTagByName(name);
