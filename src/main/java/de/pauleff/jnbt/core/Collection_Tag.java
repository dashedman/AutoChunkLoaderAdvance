 ...
 * @see Tag_List
 */
public class Collection_Tag extends de.pauleff.jnbt.core.Tag<ArrayList<de.pauleff.jnbt.core.Tag<?>>>
{
    /**
     ...
     */
    public Collection_Tag(int id, String name, ArrayList<de.pauleff.jnbt.core.Tag<?>> data)
    {
        super(id, name, data);
    }
    ...
    public Collection_Tag addTag(ITag<?> tag)
    {
        ...
        this.getData().add((de.pauleff.jnbt.core.Tag<?>) tag);
        return this;
    }
     ...
     * @see #addTag(ITag)
     */
    public Collection_Tag addAllTags(List<de.pauleff.jnbt.core.Tag<?>> tags)
    {
        if (this instanceof Tag_List list)
        {
            for (de.pauleff.jnbt.core.Tag<?> tag : tags)
            {
     ...
     */
    public List<de.pauleff.jnbt.core.Tag<?>> getAllTagsByName(String name)
    {
     ...
     */
    public de.pauleff.jnbt.core.Tag<?> getTagByName(String name)
    {
     ...
     */
    private List<de.pauleff.jnbt.core.Tag<?>> getTagsByName(String name, boolean global)
    {
        List<de.pauleff.jnbt.core.Tag<?>> tags = new ArrayList<>();
        for (de.pauleff.jnbt.core.Tag<?> tag : this.getData())
        {
     ...
     *
     * <p>Uses {@link de.pauleff.jnbt.core.Tag#equals(Object)} for comparison and searches recursively.</p>
     *
     * @param targetTag the tag to match against
     * @return list of equal tags (empty if none found)
     * @see #getTag(de.pauleff.jnbt.core.Tag)
     */
    public List<de.pauleff.jnbt.core.Tag<?>> getAllTags(de.pauleff.jnbt.core.Tag<?> targetTag)
    {
     ...
     * @see #getAllTags(de.pauleff.jnbt.core.Tag)
     */
    public de.pauleff.jnbt.core.Tag<?> getTag(de.pauleff.jnbt.core.Tag<?> targetTag)
    {
     ...
     * @return list of matching tags
     */
    private List<de.pauleff.jnbt.core.Tag<?>> getTags(de.pauleff.jnbt.core.Tag<?> targetTag, boolean global)
    {
        List<de.pauleff.jnbt.core.Tag<?>> tags = new ArrayList<>();
        for (de.pauleff.jnbt.core.Tag<?> tag : this.getData())
        {
    ...
    {
        Iterator<de.pauleff.jnbt.core.Tag<?>> iterator = this.getData().iterator();
        while (iterator.hasNext())
        {
            de.pauleff.jnbt.core.Tag<?> tag = iterator.next();
            if (tag.getName().equals(name))
            {
                iterator.remove();
                if (!global) return;
     ...
     *
     * <p>Uses {@link de.pauleff.jnbt.core.Tag#equals(Object)} for comparison and removes recursively.</p>
     *
     * @param targetTag the tag to remove
     * @see #removeTag(de.pauleff.jnbt.core.Tag)
     */
    public void removeAllTags(de.pauleff.jnbt.core.Tag<?> targetTag)
    {
     ...
     * @param targetTag the tag to remove
     * @return this collection tag for method chaining
     * @see #removeAllTags(de.pauleff.jnbt.core.Tag)
     */
    public Collection_Tag removeTag(de.pauleff.jnbt.core.Tag<?> targetTag)
    {
     ...
     * @param global    true to remove all matches, false to stop at first removal
     */
    private void removeTags(de.pauleff.jnbt.core.Tag<?> targetTag, boolean global)
    {
        Iterator<de.pauleff.jnbt.core.Tag<?>> iterator = this.getData().iterator();
        while (iterator.hasNext())
        {
