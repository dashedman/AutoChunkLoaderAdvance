 ...
 * <p>Extends {@link de.pauleff.jnbt.core.Collection_Tag} with list-specific type validation and
...
public class Tag_List extends Collection_Tag implements IListTag
{
     ...
     */
    public Tag_List(String name, int listTypeID, ArrayList<de.pauleff.jnbt.core.Tag<?>> data)
    {
     ...
     * @throws IllegalArgumentException if list type is not {@link de.pauleff.jnbt.core.Tag_String}
     * @see #getListTypeID()
     */
    public IListTag addString(String name, String value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_String(name, value));
        return this;
    }
     ...
     * @return this list tag for fluent operations
     * @throws IllegalArgumentException if list type is not {@link de.pauleff.jnbt.core.Tag_Int}
     * @see #getListTypeID()
     */
    public IListTag addInt(String name, int value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Int(name, value));
        return this;
    }
     ...
     * @return this list tag for fluent operations
     * @throws IllegalArgumentException if list type is not {@link de.pauleff.jnbt.core.Tag_Double}
     * @see #getListTypeID()
     */
    public IListTag addDouble(String name, double value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Double(name, value));
        return this;
    }
     ...
     * @param name the element name
     * @return this list tag for fluent operations
     * @throws IllegalArgumentException if list type is not {@link de.pauleff.jnbt.core.Tag_Compound}
     * @see #getListTypeID()
     */
    public IListTag addCompound(String name)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Compound(name));
        return this;
    }
     ...
     * @return this list tag for fluent operations
     * @throws IllegalArgumentException if list type is not {@link de.pauleff.jnbt.core.Tag_Float}
     * @see #getListTypeID()
     */
    public IListTag addFloat(String name, float value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Float(name, value));
        return this;
    }
     ...
     * @return this list tag for fluent operations
     * @throws IllegalArgumentException if list type is not {@link de.pauleff.jnbt.core.Tag_Byte}
     * @see #getListTypeID()
     */
    public IListTag addByte(String name, byte value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Byte(name, value));
        return this;
    }
     ...
     * @return this list tag for fluent operations
     * @throws IllegalArgumentException if list type is not {@link de.pauleff.jnbt.core.Tag_Long}
     * @see #getListTypeID()
     */
    public IListTag addLong(String name, long value)
    {
        this.addTag(new de.pauleff.jnbt.core.Tag_Long(name, value));
        return this;
    }
    ...
    public IListTag setTag(int index, ITag<?> tag)
    {
        ...
        getData().set(index, (de.pauleff.jnbt.core.Tag<?>) tag);
        return this;
    }
