 ...
 *
 * @author Paul Ferlitz
 * @see de.pauleff.jnbt.builder.NBTBuilder
 * @see de.pauleff.jnbt.builder.ListBuilder
 * @see Tag_Compound
 */
public class CompoundBuilder extends de.pauleff.jnbt.builder.NBTBuilder
{
     ...
     */
    public CompoundBuilder(String name, de.pauleff.jnbt.builder.NBTBuilder parent)
    {
        super(name, parent);
        validateName(name);
     ...
     * @param parent           the parent builder for nesting support, or null for root compounds
     */
    public CompoundBuilder(ICompoundTag existingCompound, de.pauleff.jnbt.builder.NBTBuilder parent)
    {
     ...
     * @return a {@link de.pauleff.jnbt.builder.ListBuilder} for adding list elements
     * @see NBTTags
     */
    public de.pauleff.jnbt.builder.ListBuilder addList(String name, NBTTags listType)
    {
        validateName(name);
        return new de.pauleff.jnbt.builder.ListBuilder(name, listType, this);
    }
     ...
     * </ul>
     *
     * @return the parent {@link de.pauleff.jnbt.builder.NBTBuilder} to continue building
     * @throws IllegalStateException if called on a root builder (use {@link #build()} instead)
     * @since 1.3.0
     */
    @Override
    public de.pauleff.jnbt.builder.NBTBuilder end()
    {
        if (parent == null)
        {
        ...
        } else if (parent instanceof de.pauleff.jnbt.builder.ListBuilder parentList)
        {
    ...
    {
        de.pauleff.jnbt.builder.NBTBuilder parent = end();
     ...
     * @since 1.5.0
     */
    public de.pauleff.jnbt.builder.ListBuilder endList()
    {
