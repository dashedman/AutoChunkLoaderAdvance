 ...
 *
 * @author Paul Ferlitz
 * @see de.pauleff.jnbt.api.ICompoundTag
...
public interface INBTReader extends AutoCloseable
{
     ...
     * Since NBT files always have compound tags as roots in Java Edition, this returns an {@link de.pauleff.jnbt.api.ICompoundTag}.
     *
     * @return The root {@link de.pauleff.jnbt.api.ICompoundTag} containing the complete NBT structure
